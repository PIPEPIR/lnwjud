...
export const UPGRADE_TOOL_CATALOG: readonly UpgradeToolCatalogEntry[] = [
  ...
  read('office_status', 46, 'Report truthful Office provider, app, action, dependency, and policy readiness without exposing credentials.', ['office', 'status', 'provider']),
  write('office_word', 46, 'Read, create, edit, inspect, merge, convert, and validate Word documents through a verified Office provider.', ['office', 'word', 'document'], { availability: 'optional', requirements: ['verified Word provider for requested action', 'registered workspace for local files'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-document' }),
  write('office_excel', 46, 'Automate structured Excel workbook reads, edits, formulas, sheets, formatting, exports, and validation through a verified provider.', ['office', 'excel', 'spreadsheet'], { availability: 'optional', requirements: ['verified Excel provider for requested action', 'registered workspace for local files'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-workbook' }),
  write('office_powerpoint', 46, 'Author, inspect, edit, export, and validate PowerPoint presentations through a verified provider.', ['office', 'powerpoint', 'presentation'], { availability: 'optional', requirements: ['verified PowerPoint provider for requested action', 'registered workspace for local files'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-presentation' }),
  write('office_outlook', 46, 'Read Outlook mail, create and update drafts, and perform guarded mailbox mutations through a verified provider.', ['office', 'outlook', 'mail'], { availability: 'optional', requirements: ['verified Outlook or Microsoft Graph provider'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-mail' }),
  write('office_calendar', 46, 'Read and manage Outlook/Microsoft 365 calendar events through a verified provider with guarded invite/cancel actions.', ['office', 'calendar'], { availability: 'optional', requirements: ['verified Outlook or Microsoft Graph calendar provider'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-calendar' }),
  write('office_contacts', 46, 'Read and manage Outlook/Microsoft 365 contacts through a verified provider.', ['office', 'contacts'], { availability: 'optional', requirements: ['verified Outlook or Microsoft Graph contacts provider'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-contacts' }),
  write('office_tasks', 46, 'Read and manage Outlook/Microsoft 365 tasks only when the configured provider exposes a compatible task API.', ['office', 'tasks'], { availability: 'optional', requirements: ['verified Outlook or Microsoft Graph tasks provider'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-tasks' }),
  write('office_onenote', 46, 'Read and manage OneNote through Microsoft Graph when OAuth and required scopes are configured.', ['office', 'graph', 'onenote'], { availability: 'optional', requirements: ['Microsoft Graph OAuth', 'OneNote scopes'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-cloud' }),
  write('office_onedrive', 46, 'Manage OneDrive files through Microsoft Graph while respecting Active Project boundaries for local transfers.', ['office', 'graph', 'onedrive'], { availability: 'optional', requirements: ['Microsoft Graph OAuth', 'OneDrive scopes'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-cloud' }),
  write('office_sharepoint', 46, 'Read and manage bounded SharePoint sites, lists, drives, and files through Microsoft Graph.', ['office', 'graph', 'sharepoint'], { availability: 'optional', requirements: ['Microsoft Graph OAuth', 'SharePoint scopes'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-cloud' }),
  write('office_teams', 46, 'Read and send guarded Microsoft Teams messages only through supported Microsoft Graph permissions.', ['office', 'graph', 'teams'], { availability: 'optional', requirements: ['Microsoft Graph OAuth', 'Teams scopes'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-cloud' }),
  write('office_access', 46, 'Automate Microsoft Access only when a verified local Access provider is installed.', ['office', 'access', 'windows'], { availability: 'optional', requirements: ['Windows host', 'Microsoft Access automation provider'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-database' }),
  write('office_visio', 46, 'Automate Microsoft Visio only when a verified local Visio provider is installed.', ['office', 'visio', 'windows'], { availability: 'optional', requirements: ['Windows host', 'Microsoft Visio automation provider'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-diagram' }),
  write('office_project', 46, 'Automate Microsoft Project only when a verified local Project provider is installed.', ['office', 'project', 'windows'], { availability: 'optional', requirements: ['Windows host', 'Microsoft Project automation provider'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-project' }),
  write('office_publisher', 46, 'Automate legacy Microsoft Publisher only when an installed automation provider is verified.', ['office', 'publisher', 'windows'], { availability: 'optional', requirements: ['Windows host', 'Microsoft Publisher automation provider'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-publication' }),
  write('office_convert', 46, 'Convert supported Office formats through a verified provider and verify the produced artifact before reporting success.', ['office', 'convert'], { availability: 'optional', requirements: ['verified Office conversion provider', 'registered workspace'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-conversion' }),
  write('office_batch', 46, 'Run a bounded ordered Office batch with per-step results, dry-run support, and fail-fast semantics; operations are not atomic across apps.', ['office', 'batch'], { availability: 'optional', requirements: ['verified provider for each requested operation'], supportsCancel: true, supportsDryRun: true, auditTarget: 'office-batch' }),
