...
const prepareSchema = z.object({
  ...
  connectorMention: connectorMention.optional(),
  ...
  return [
    defineTool({
      ...
      handler: async (input) => context.services.scheduledContinuations?.prepareScheduledContinuation(context.actor, {
        ...
        ...(input.connectorMention === undefined ? {} : { connectorMention: input.connectorMention }),
