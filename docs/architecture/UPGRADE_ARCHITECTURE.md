...
Status: God-Tier local-first implementation checkpoint synchronized for `v4.70.0`.
...
MCP clients (ChatGPT / Codex / Claude / other agents)
             ...
             MCP stdio or loopback Streamable HTTP
                         |
                         v
                  ToolRegistry (242 total definitions; 235 default; all 242 with Codex + Agent Swarm)
                         |
       +-----------------+------------------+
       |                 |                  |
       v                 v                  v
