...
Status: God-Tier local-first implementation checkpoint synchronized for `v5.0.1`.
...
MCP clients (ChatGPT / Codex / Claude / other agents)
             ...
             MCP stdio or loopback Streamable HTTP
                         |
                         v
                  ToolRegistry (253 total definitions; 246 default; all 253 with Codex + Agent Swarm)
                         |
       +-----------------+------------------+
       |                 |                  |
       v                 v                  v
