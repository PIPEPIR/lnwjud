...
current v4.70.0 runtime contract is 242 total definitions, 235 advertised by
default, and all 242 when Codex delegation plus Agent Swarm is enabled; see the current catalog and
