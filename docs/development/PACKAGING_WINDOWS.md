...
`apps/desktop/electron-builder.yml` is the source of truth. The current v5.1.0 packaging contract is:
...
apps/desktop/dist/installers/lnwjud-Setup-5.1.0.exe.blockmap
