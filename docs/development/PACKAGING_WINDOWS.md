...
`apps/desktop/electron-builder.yml` is the source of truth. The current v5.6.3 packaging contract is:
...
apps/desktop/dist/installers/lnwjud-Setup-5.6.3.exe.blockmap
