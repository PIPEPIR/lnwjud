...
`apps/desktop/electron-builder.yml` is the source of truth. The current v5.4.0 packaging contract is:
...
apps/desktop/dist/installers/lnwjud-Setup-5.4.0.exe.blockmap
