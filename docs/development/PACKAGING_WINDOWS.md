...
`apps/desktop/electron-builder.yml` is the source of truth. The current v5.2.1 packaging contract is:
...
apps/desktop/dist/installers/lnwjud-Setup-5.2.1.exe.blockmap
