...
`apps/desktop/electron-builder.yml` is the source of truth. The current v4.70.0 packaging contract is:
...
apps/desktop/dist/installers/lnwjud-Setup-4.70.0.exe.blockmap
