...
`apps/desktop/electron-builder.yml` is the source of truth. The current v4.63.0 packaging contract is:
...
apps/desktop/dist/installers/lnwjud-Setup-4.63.0.exe.blockmap
