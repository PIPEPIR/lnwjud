# คู่มือใช้งาน lnwjud v5.0.1 (ภาษาไทย)
...
- `lnwjud-Setup-5.0.1.exe` หรือ `lnwjud-Portable-5.0.1.exe`
...
1. ดาวน์โหลด `lnwjud-Setup-5.0.1.exe` จาก GitHub Releases
2. ติดตั้งตามปกติ
...
1. ดาวน์โหลด `lnwjud-Portable-5.0.1.exe`
