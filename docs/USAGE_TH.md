# คู่มือใช้งาน lnwjud v5.4.2 (ภาษาไทย)
...
คู่มือนี้อัปเดตตาม source `v5.4.2`; public release `v5.4.1` คือรุ่นที่เผยแพร่แล้วบน [GitHub Releases](https://github.com/engasnm111/lnwjud/releases/tag/v5.4.1)
...
- public release ล่าสุด `lnwjud-Setup-5.4.1.exe` หรือ `lnwjud-Portable-5.4.1.exe`
...
1. ดาวน์โหลด public release ล่าสุด `lnwjud-Setup-5.4.1.exe` จาก GitHub Releases
2. ติดตั้งตามปกติ
...
1. ดาวน์โหลด public release ล่าสุด `lnwjud-Portable-5.4.1.exe`
