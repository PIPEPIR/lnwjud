...
คู่มือนี้อัปเดตตาม source และ public release `v5.4.0` ปัจจุบัน ไฟล์ release ที่เผยแพร่แล้วอยู่ที่ [GitHub Releases](https://github.com/engasnm111/lnwjud/releases/tag/v5.4.0)
