# คู่มือใช้งาน lnwjud v5.5.2 (ภาษาไทย)
...
คู่มือนี้อัปเดตตาม public release `v5.5.2` บน [GitHub Releases](https://github.com/engasnm111/lnwjud/releases/tag/v5.5.2)
...
- public release ล่าสุด `lnwjud-Setup-5.5.2.exe` หรือ `lnwjud-Portable-5.5.2.exe`
...
1. ดาวน์โหลด public release ล่าสุด `lnwjud-Setup-5.5.2.exe` จาก GitHub Releases
2. ติดตั้งตามปกติ
...
1. ดาวน์โหลด public release ล่าสุด `lnwjud-Portable-5.5.2.exe`
