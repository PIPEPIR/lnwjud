...
คู่มือนี้อัปเดตตาม source และ public release `v5.3.1` ปัจจุบัน ไฟล์ release ที่เผยแพร่แล้วอยู่ที่ [GitHub Releases](https://github.com/engasnm111/lnwjud/releases/tag/v5.3.1)
...
- public release ล่าสุด `lnwjud-Setup-5.3.1.exe` หรือ `lnwjud-Portable-5.3.1.exe`
...
1. ดาวน์โหลด public release ล่าสุด `lnwjud-Setup-5.3.1.exe` จาก GitHub Releases
2. ติดตั้งตามปกติ
...
1. ดาวน์โหลด public release ล่าสุด `lnwjud-Portable-5.3.1.exe`
