# คู่มือใช้งาน lnwjud v5.0.0 (ภาษาไทย)
...
- `lnwjud-Setup-5.0.0.exe` หรือ `lnwjud-Portable-5.0.0.exe`
...
1. ดาวน์โหลด `lnwjud-Setup-5.0.0.exe` จาก GitHub Releases
2. ติดตั้งตามปกติ
...
1. ดาวน์โหลด `lnwjud-Portable-5.0.0.exe`
