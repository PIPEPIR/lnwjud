# คู่มือใช้งาน lnwjud v5.4.1 (ภาษาไทย)
...
คู่มือนี้อัปเดตตาม source `v5.4.1`; public release `v5.4.1` คือรุ่นที่เผยแพร่แล้วบน [GitHub Releases](https://github.com/engasnm111/lnwjud/releases/tag/v5.4.1)
