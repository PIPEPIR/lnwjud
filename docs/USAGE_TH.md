# คู่มือใช้งาน lnwjud v4.63.0 (ภาษาไทย)
...
- `lnwjud-Setup-4.63.0.exe` หรือ `lnwjud-Portable-4.63.0.exe`
...
1. ดาวน์โหลด `lnwjud-Setup-4.63.0.exe` จาก GitHub Releases
2. ติดตั้งตามปกติ
...
1. ดาวน์โหลด `lnwjud-Portable-4.63.0.exe`
