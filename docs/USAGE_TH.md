# คู่มือใช้งาน lnwjud v4.62.3 (ภาษาไทย)
...
- `lnwjud-Setup-4.62.3.exe` หรือ `lnwjud-Portable-4.62.3.exe`
...
1. ดาวน์โหลด `lnwjud-Setup-4.62.3.exe` จาก GitHub Releases
2. ติดตั้งตามปกติ
...
1. ดาวน์โหลด `lnwjud-Portable-4.62.3.exe`
