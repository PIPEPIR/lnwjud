# คู่มือใช้งาน lnwjud v5.6.1 (ภาษาไทย)
...
คู่มือนี้อัปเดตตาม public release `v5.6.1` บน [GitHub Releases](https://github.com/engasnm111/lnwjud/releases/tag/v5.6.1)
...
- public release ล่าสุด `lnwjud-Setup-5.6.1.exe` หรือ `lnwjud-Portable-5.6.1.exe`
...
1. ดาวน์โหลด public release ล่าสุด `lnwjud-Setup-5.6.1.exe` จาก GitHub Releases
2. ติดตั้งตามปกติ
...
1. ดาวน์โหลด public release ล่าสุด `lnwjud-Portable-5.6.1.exe`
