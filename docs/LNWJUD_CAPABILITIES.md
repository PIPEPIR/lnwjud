...
สถานะเอกสาร: สรุปจาก source และ runtime contract ปัจจุบันของ lnwjud v5.2.1 (มีทั้งหมด 253 definitions; advertise 241 tools โดยปริยายก่อนใช้ per-tool override และครบ 253 tools เมื่อเปิด Codex delegation กับ Agent Swarm)
