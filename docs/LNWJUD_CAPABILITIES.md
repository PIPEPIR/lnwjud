...
สถานะเอกสาร: สรุปจาก source และ runtime contract ปัจจุบันของ lnwjud v5.4.1 (มีทั้งหมด 259 definitions; advertise 247 tools โดยปริยายก่อนใช้ per-tool override และครบ 259 tools เมื่อเปิด Codex delegation กับ Agent Swarm)
