...
สถานะเอกสาร: สรุปจาก source และ runtime contract ปัจจุบันของ lnwjud v4.70.0 (มีทั้งหมด 242 definitions; advertise 235 tools โดยปริยายก่อนใช้ per-tool override และครบ 242 tools เมื่อเปิด Codex delegation กับ Agent Swarm)
